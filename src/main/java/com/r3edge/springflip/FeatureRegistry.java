...
/**
 * Service centralisé permettant d'accéder dynamiquement à l'état des
 * fonctionnalités (feature toggles) définies dans la configuration de
 * l'application.
 * <p>
 * Ce composant est compatible avec le rechargement à chaud via
 * {@code /actuator/refresh} lorsqu'il est combiné à une source de configuration
 * dynamique (YAML, Spring Cloud Config, etc.).
 * </p>
 */
@Component
